...
const ORDERS = [
  {
    ...
    items: [
      {
        productId: 4001n,
        productNameSnapshot: "Tai nghe Bluetooth CNB-01",
        priceSnapshot: "890000.00",
        quantity: 1,
        subtotal: "890000.00",
      },
      {
        productId: 4002n,
        productNameSnapshot: "Chuột không dây CNM-02",
        priceSnapshot: "390000.00",
        quantity: 2,
        subtotal: "780000.00",
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        productId: 4008n,
        productNameSnapshot: "Nồi chiên không dầu CSH-03",
      ...
      {
        productId: 4010n,
        productNameSnapshot: "Bình giữ nhiệt CSH-05",
        priceSnapshot: "260000.00",
        quantity: 1,
        subtotal: "260000.00",
      },
    ],
