...
const ShopList = () => {
    ...
    const fallbackData = [
        { desc: t('Thời trang cao cấp với những xu hướng mới nhất mang phong cách hiện đại và thời thượng.'), img: 'https://images.unsplash.com/photo-1618220179428-22790b46a0eb?q=80&w=300&auto=format&fit=crop' },
        { desc: t('Khơi nguồn cảm hứng từ thiên nhiên, mang vẻ đẹp nguyên bản vào không gian sống.'), img: 'https://images.unsplash.com/photo-1490312278390-ab64016e0aa9?q=80&w=300&auto=format&fit=crop' },
        { desc: t('Chế tác gốm sứ nghệ thuật, giao thoa giữa nét đẹp cổ điển và thiết kế đương đại.'), img: 'https://images.unsplash.com/photo-1610701596007-11502861dcfa?q=80&w=300&auto=format&fit=crop' },
        { desc: t('Đồ gia dụng và nội thất cao cấp mang lại sự sang trọng và tiện nghi cho gia đình bạn.'), img: 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?q=80&w=300&auto=format&fit=crop' },
    ];
    ...
    useEffect(() => {
        const fetchShops = async () => {
            try {
                ...
                console.error(t("Lỗi khi tải danh sách shop:"), error);
            } finally {
                setLoading(false);
            }
        };
        ...
        <main className="pt-32 pb-24 px-6 max-w-screen-2xl mx-auto min-h-screen font-['Inter'] bg-[#f9f9fc]">
            ...
            <header className="mb-16 md:mb-24 flex flex-col items-center text-center">
                ...
                <p className="text-gray-500 text-lg md:text-xl max-w-2xl font-light leading-relaxed">
                    {t('Kết nối trực tiếp đến các nhà phân phối và cửa hàng uy tín hàng đầu. Nơi mang lại trải nghiệm mua sắm đáng tin cậy với chất lượng dịch vụ tốt nhất.')}
                </p>
            </header>
                ...
                <div className="bg-white p-4 rounded-full shadow-[0_8px_24px_rgba(43,56,150,0.04)] flex flex-col md:flex-row items-center gap-4 border border-gray-100">
                    <div className="relative flex-grow w-full md:w-auto">
                        ...
                        <input 
                            ...
                            placeholder={t("Tìm kiếm cửa hàng theo tên...")}
                        />
                    </div>
                </div>
            </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                {loading ? (
                    ...
                    <div className="col-span-full text-center py-20 bg-white rounded-2xl border border-gray-100">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2 font-['Be_Vietnam_Pro']">{t('Không tìm thấy cửa hàng')}</h3>
                        <p className="text-gray-500">{t('Chưa có cửa hàng nào khớp với từ khóa tìm kiếm của bạn.')}</p>
                    </div>
                ) : (
                ...
                {!loading && (
                    <article className="bg-[#f9f9fc] p-8 rounded-xl flex flex-col items-center text-center group transition-transform duration-300 border-2 border-dashed border-gray-300 hover:border-[#2b3896]/50 hover:bg-white justify-center min-h-[400px]">
                        <div className="flex flex-col items-center text-gray-500 p-6">
                            ...
                            <p className="font-bold text-gray-900 mb-1 font-['Be_Vietnam_Pro']">{t('Bạn muốn bán hàng?')}</p>
                            <p className="text-sm opacity-80 mb-8">{t('Bắt đầu hành trình kinh doanh của bạn cùng chúng tôi')}</p>
                            <Link 
                                to="/register"
